...
class Crossbow extends ConcreteEnchantable {
    ...
    Crossbow(int priorWork, bool isDamaged, Set<Enchantment> enchantments) : super(priorWork, isDamaged, enchantments) {
    }
...
class TurtleHelmet extends ConcreteEnchantable {
    ...
    TurtleHelmet(int priorWork, bool isDamaged, Set<Enchantment> enchantments) : super(priorWork, isDamaged, enchantments) {
    }

    TurtleHelmet clone() {
        return TurtleHelmet(this.priorWork, this.isDamaged, this.cloneEnchantments());
    }
}
class FlintandSteel extends ConcreteEnchantable {
    final String fullName = 'Flint and Steel';
    final Symbol typeId = #FlintandSteel;
    FlintandSteel(int priorWork, bool isDamaged, Set<Enchantment> enchantments) : super(priorWork, isDamaged, enchantments) {
    }
...
class Hoe extends ConcreteEnchantable {
    ...
    Hoe(int priorWork, bool isDamaged, Set<Enchantment> enchantments) : super(priorWork, isDamaged, enchantments) {
    }
...
class Pickaxe extends ConcreteEnchantable {
    ...
    Pickaxe(int priorWork, bool isDamaged, Set<Enchantment> enchantments) : super(priorWork, isDamaged, enchantments) {
    }
...
class Book extends ConcreteEnchantable {
    ...
    Book(int priorWork, bool isDamaged, Set<Enchantment> enchantments) : super(priorWork, isDamaged, enchantments) {
    }
...
List<String> allItems = ["Boots", "Bow", "Crossbow", "Helmet", "Carved Pumpkin", "Elytra", "Shield", "Fishing Rod", "Turtle Helmet", "Flint and Steel", "Axe", "Hoe", "Pickaxe", "Leggings", "Shears", "Warped Fungus on a Stick", "Carrot on a Stick", "Head", "Book", "Trident", "Sword", "Shovel", "Chestplate"];
