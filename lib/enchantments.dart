...
class FeatherFalling extends Enchantment {
  ...
  static const Set<String> compatibleItemSet = const {"Boots", "Book"};
  bool applicable(ConcreteEnchantable tool) {
...
class Sharpness extends Enchantment {
  ...
  static const Set<String> compatibleItemSet = const {"Axe", "Sword", "Book"};
  bool applicable(ConcreteEnchantable tool) {
...
class Knockback extends Enchantment {
  ...
  static const Set<String> compatibleItemSet = const {"Sword", "Book"};
  bool applicable(ConcreteEnchantable tool) {
...
class Power extends Enchantment {
  ...
  static const Set<String> compatibleItemSet = const {"Bow", "Book"};
  bool applicable(ConcreteEnchantable tool) {
...
class LuckoftheSea extends Enchantment {
  ...
  static const Set<String> compatibleItemSet = const {"Fishing Rod", "Book"};
  bool applicable(ConcreteEnchantable tool) {
...
class Impaling extends Enchantment {
  ...
  static const Set<String> compatibleItemSet = const {"Trident", "Book"};
  bool applicable(ConcreteEnchantable tool) {
