...
class Protection extends Enchantment {
    ...
    static const Set<String> compatibleItemSet = const {"Turtle Helmet", "Leggings", "Boots", "Book", "Helmet", "Chestplate"};
...
class Respiration extends Enchantment {
    ...
    static const Set<String> compatibleItemSet = const {"Book", "Helmet", "Turtle Helmet"};
    bool applicable(ConcreteEnchantable tool) {
...
class Efficiency extends Enchantment {
    ...
    static const Set<String> compatibleItemSet = const {"Pickaxe", "Shears", "Book", "Axe", "Shovel"};
    bool applicable(ConcreteEnchantable tool) {
...
class SilkTouch extends Enchantment {
    ...
    static const Set<String> compatibleItemSet = const {"Pickaxe", "Book", "Axe", "Shovel"};
    bool applicable(ConcreteEnchantable tool) {
...
class Unbreaking extends Enchantment {
    ...
    static const Set<String> compatibleItemSet = const {"Boots", "Bow", "Crossbow", "Helmet", "Elytra", "Shield", "Fishing Rod", "Flint and Steel", "Axe", "Hoe", "Pickaxe", "Leggings", "Shears", "Warped Fungus on a Stick", "Carrot on a Stick", "Book", "Turtle Helmet", "Trident", "Sword", "Shovel", "Chestplate"};
    bool applicable(ConcreteEnchantable tool) {
...
class CurseofBinding extends Enchantment {
    ...
    static const Set<String> compatibleItemSet = const {"Leggings", "Boots", "Carved Pumpkin", "Helmet", "Head", "Elytra", "Book", "Turtle Helmet", "Chestplate"};
    bool applicable(ConcreteEnchantable tool) {
...
class CurseofVanishing extends Enchantment {
    ...
    static const Set<String> compatibleItemSet = const {"Boots", "Bow", "Carved Pumpkin", "Helmet", "Crossbow", "Elytra", "Shield", "Fishing Rod", "Turtle Helmet", "Flint and Steel", "Hoe", "Pickaxe", "Leggings", "Shears", "Trident", "Warped Fungus on a Stick", "Carrot on a Stick", "Head", "Book", "Axe", "Sword", "Shovel", "Chestplate"};
    bool applicable(ConcreteEnchantable tool) {
